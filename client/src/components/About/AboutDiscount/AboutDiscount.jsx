      ...
      >
        <div className='wrapper'>
          <div className='discount-info'>
            ...
            <h2> BeautyShop develops its own brands</h2>
            <p>
              The BeautyShop network is being developed and improved, taking into
            ...
            <p className='discount-info__sm'>
              ...
              and care.BeautyShop stores offer their customers the widest and
